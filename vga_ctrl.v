...
parameter	    V_SYNC	=	10'd2	,
    ...
    reg disp_active_d;
    always @(posedge vga_clk) disp_active_d <= rgb_valid;

    assign read_req = disp_active_d; // SDRAM数据提前一拍输出
	...
	assign	hsync = ((cnt_h <= H_SYNC - 1'b1)&&(sys_rst_n)) ? 1'b1 : 1'b0;
	assign	vsync = ((cnt_v <= V_SYNC - 1'b1)&&(sys_rst_n)) ? 1'b1 : 1'b0;
